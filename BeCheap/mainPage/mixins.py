...
class Pagination_class(FilterQueryForPagination):
    pagination_size = 10  # размер по умолчанию
    query = None

    def get_page(self, page_number, serializer_class, **kwargs):
        if kwargs['cache_name']:
